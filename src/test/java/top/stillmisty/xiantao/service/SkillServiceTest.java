...
class SkillServiceTest {
    ...
    void learnFromJade_whenAlreadyLearned_shouldReturnFailure() {
        ...
        when(playerSkillRepository.findByUserIdAndSkillId(userId, skillId)).thenReturn(Optional.of(new PlayerSkill()));
    ...
    private void setUpJadeMock(Skill skill, StackableItem jade) {
        when(stackableItemRepository.findByUserId(userId))
                .thenReturn(List.of(jade));
