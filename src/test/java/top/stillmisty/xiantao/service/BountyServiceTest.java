...
class BountyServiceTest {
    ...
    @Mock
    private UserBountyRepository userBountyRepository;
    @Mock
    ...
    private Bounty createBounty(int requireLevel, int durationMinutes) {
        ...
        bounty.setRewards(List.of(
            new BountyRewardPool.RareItem(100, 1, 1, "培元丹")
        ));
        return bounty;
    }
    ...
    private UserBounty createUserBounty(int durationMinutes, long minutesAgo) {
        ...
        ub.setRewards(List.of(
            new BountyRewardItem.ItemReward(1L, "培元丹", 1).toMap()
        ));
        ub.setStatus("active");
        return ub;
    }
    ...
    void getBountyStatus_whenNoActiveBounty_shouldThrow() {
        ...
        assertThrows(IllegalStateException.class,
            () -> bountyService.getBountyStatus(userId));
    }
