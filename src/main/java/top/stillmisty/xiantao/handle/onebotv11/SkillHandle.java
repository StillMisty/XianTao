...
public class SkillHandle {
    ...
    public void learnedSkills(MessageEvent event) {
        ...
        String response = skillCommandHandler.handleLearnedSkills(
    ...
    public void equipSkill(MessageEvent event, @FilterValue("skill") String skill) {
        ...
        String response = skillCommandHandler.handleEquipSkill(
                PlatformType.ONE_BOT_V11,
                event.getAuthorId().toString(),
                skill
        );
    ...
    public void unequipSkill(MessageEvent event, @FilterValue("skill") String skill) {
        ...
        String response = skillCommandHandler.handleUnequipSkill(
                PlatformType.ONE_BOT_V11,
                event.getAuthorId().toString(),
                skill
        );
    ...
    public void equippedSkills(MessageEvent event) {
        ...
        String response = skillCommandHandler.handleEquippedSkills(
                PlatformType.ONE_BOT_V11,
                event.getAuthorId().toString()
        );
        event.replyBlocking(response);
