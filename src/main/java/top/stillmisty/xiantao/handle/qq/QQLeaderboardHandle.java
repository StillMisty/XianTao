...
public class QQLeaderboardHandle {
  ...
  @ContentTrim
  @Filter("排行榜")
  public void levelLeaderboard(QGGroupAtMessageCreateEvent event) {
  ...
  @ContentTrim
  @Filter("排行榜 灵石")
  public void spiritStoneLeaderboard(QGGroupAtMessageCreateEvent event) {
