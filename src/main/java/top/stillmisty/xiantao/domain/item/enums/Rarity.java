...
public enum Rarity {
  ...
  public static Rarity fromCode(String code) {
    for (Rarity rarity : values()) {
      if (rarity.code.equals(code)) {
        return rarity;
      }
    }
    throw new IllegalArgumentException("Unknown Rarity code: " + code);
  }
  ...
  public double randomQualityMultiplier() {
    return qualityMultiplierMin
        + ThreadLocalRandom.current().nextDouble() * (qualityMultiplierMax - qualityMultiplierMin);
  }
