...
public class TribulationBoss implements Combatant {
    ...
    public TribulationBoss(
            int defendingTeamHp, int defendingTeamAtk, int defendingTeamDef, int defendingTeamSpd,
            int tribulationStage, boolean compassionMode
    ) {
