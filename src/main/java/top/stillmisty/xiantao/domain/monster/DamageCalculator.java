...
public class DamageCalculator {
    ...
    private static final Map<WeaponType, MonsterType> ADVANTAGE_MAP = Map.of(
    ...
    public int calculateNormalDamage(Combatant attacker, Combatant defender, BuffManager buffManager) {
    ...
    public int calculateEffectDamage(Combatant attacker, Combatant defender, SkillEffect effect, BuffManager buffManager) {
