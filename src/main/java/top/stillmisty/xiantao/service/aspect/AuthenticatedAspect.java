...
/**
 * 统一认证切面
 * 拦截 Service 中所有返回 ServiceResult 且首两个参数为 (PlatformType, String openId) 的 public 方法，
...
public class AuthenticatedAspect {
    ...
    /**
     * 匹配 Service 包下所有返回 ServiceResult、前两个参数为 (PlatformType, String, [可选 UserStatus], ...) 的方法
