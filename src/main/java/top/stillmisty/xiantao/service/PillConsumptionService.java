...
public class PillConsumptionService {
    ...
    private String applyEffect(User user, ItemProperties.Effect effect, double qualityMultiplier, int grade, long templateId) {
        return switch (effect) {
            ...
            case ItemProperties.Effect.Breakthrough e -> applyBreakthrough(user, e, qualityMultiplier, grade);
    ...
    private String applyExp(User user, ItemProperties.Effect.Exp e, double qualityMultiplier, int grade, long templateId) {
    ...
    private String applyStat(User user, ItemProperties.Effect.Stat e, double qualityMultiplier, int grade, long templateId) {
    ...
    private String applyBreakthrough(User user, ItemProperties.Effect.Breakthrough e, double qualityMultiplier, int grade) {
        double gradeDecay = calcGradeDecay(user.getLevel(), grade, true);
    ...
    private String applyBuff(User user, ItemProperties.Effect.Buff e, double qualityMultiplier, int grade) {
        double gradeDecay = calcGradeDecay(user.getLevel(), grade, true);
        ...
        var buffName = switch (e.attribute()) {
            case "attack" -> "攻击";
            case "defense" -> "防御";
            case "speed" -> "速度";
            default -> e.attribute();
