...
public class PlayerPillRecipeRepositoryImpl implements PlayerPillRecipeRepository {
    ...
    @Override
    public Optional<PlayerPillRecipe> findByUserIdAndRecipeTemplateId(Long userId, Long recipeTemplateId) {
    ...
    public void deleteByUserIdAndRecipeTemplateId(Long userId, Long recipeTemplateId) {
        mapper.selectByUserIdAndRecipeTemplateId(userId, recipeTemplateId)
