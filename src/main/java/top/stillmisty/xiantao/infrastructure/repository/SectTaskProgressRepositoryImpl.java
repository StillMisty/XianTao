...
import top.stillmisty.xiantao.domain.sect.repository.SectTaskProgressRepository;
import top.stillmisty.xiantao.infrastructure.mapper.SectTaskProgressMapper;

@Repository
@RequiredArgsConstructor
public class SectTaskProgressRepositoryImpl implements SectTaskProgressRepository {
