...
('小还丹',       'POTION', '{"effects":[{"type":"hp","amount":1000}]}',    '["pill","heal","intermediate"]', '丹如其名，小还丹却能大回血，金丹修士行走江湖的标配。'),
('九转回春丹',   'POTION', '{"effects":[{"type":"hp","amount":2000}]}',    '["pill","heal","advanced"]', '九转炼制的回春丹，只要还有一口气就能拉回来。'),
('大回春丹',     'POTION', '{"effects":[{"type":"hp","amount":3500}]}',    '["pill","heal","advanced"]', '回春丹的终极强化版，化神大能也要嗑上一颗以备不测。'),
...
('壮骨丹',       'POTION', '{"effects":[{"type":"stat","statAttr":"STR","amount":10}]}',  '["pill","stat","str","entry"]', '淬炼筋骨，增力十钧，服后感觉能一拳打死一头牛。'),
('金刚散',       'POTION', '{"effects":[{"type":"stat","statAttr":"CON","amount":10}]}',  '["pill","stat","con","entry"]', '锤炼皮膜内脏，固本培元，挨打时没那么疼了。'),
('轻身散',       'POTION', '{"effects":[{"type":"stat","statAttr":"AGI","amount":10}]}',  '["pill","stat","agi","entry"]', '身轻如燕草上飞，服后走路自带残影。'),
('开智丹',       'POTION', '{"effects":[{"type":"stat","statAttr":"WIS","amount":10}]}',  '["pill","stat","wis","entry"]', '开启灵台，悟性大增，以前看不懂的法决突然就通了。'),
('龙力丹',       'POTION', '{"effects":[{"type":"stat","statAttr":"STR","amount":30}]}',  '["pill","stat","str","rare"]', '以龙血草为主材，服后力道暴涨。'),
('虎骨丹',       'POTION', '{"effects":[{"type":"stat","statAttr":"STR","amount":20}]}',  '["pill","stat","str","basic"]', '以虎骨为主材炼制，力道稳步提升，药性温和不易反弹。'),
('不动明王丹',   'POTION', '{"effects":[{"type":"stat","statAttr":"CON","amount":30}]}', '["pill","stat","con","rare"]', '如明王端坐不动，筋骨如金刚，打不死的是我。'),
('玄武甲丹',     'POTION', '{"effects":[{"type":"stat","statAttr":"CON","amount":20}]}', '["pill","stat","con","basic"]', '以玄武龟甲碎片入药，服后皮糙肉厚扛揍翻倍。'),
('踏风丹',       'POTION', '{"effects":[{"type":"stat","statAttr":"AGI","amount":30}]}', '["pill","stat","agi","rare"]', '御风而行，踏虚凌空，金丹以下都看不清你的影子。'),
('追风丹',       'POTION', '{"effects":[{"type":"stat","statAttr":"AGI","amount":20}]}', '["pill","stat","agi","basic"]', '服后两腿生风，跑得比兔子还快——修仙界的小电驴。'),
('大悟道丹',     'POTION', '{"effects":[{"type":"stat","statAttr":"WIS","amount":30}]}', '["pill","stat","wis","rare"]', '以菩提叶炼成，有人吃了直接顿悟破境——但那是他的机缘。'),
('玲珑心丹',     'POTION', '{"effects":[{"type":"stat","statAttr":"WIS","amount":20}]}', '["pill","stat","wis","basic"]', '开启灵台第七窍，虽不至醍醐灌顶也差不太多。'),
...
('碎丹丹',       'POTION', '{"effects":[{"type":"breakthrough","rate":0.25}]}', '["pill","breakthrough","intermediate"]', '金丹后期碎丹凝婴的辅助丹药，药力温和适合多次尝试。'),
('化婴丹',       'POTION', '{"effects":[{"type":"breakthrough","rate":0.4}]}', '["pill","breakthrough","epic"]', '金丹圆满破碎化婴，从此踏上真正仙途。丹成九转方可得。'),
('炼神丹',       'POTION', '{"effects":[{"type":"breakthrough","rate":0.3}]}', '["pill","breakthrough","advanced"]', '元婴期淬炼元神的秘制丹药，突破化神的关键助力。'),
('化神丹',       'POTION', '{"effects":[{"type":"breakthrough","rate":0.5}]}', '["pill","breakthrough","legendary"]', '元婴圆满冲击化神之用，此丹已成天下绝品，可遇不可求。'),
('融虚丹',       'POTION', '{"effects":[{"type":"breakthrough","rate":0.35}]}', '["pill","breakthrough","grand"]', '化神巅峰融化虚空踏入炼虚的奇丹，所需药材极尽珍稀。'),
('大乘丹',       'POTION', '{"effects":[{"type":"breakthrough","rate":0.45}]}', '["pill","breakthrough","mythic"]', '传说以九千年一熟的朱果为主材，大乘修士也未必见过丹方。'),
...
('炼体丹',       'POTION', '{"effects":[{"type":"stat","statAttr":"STR","amount":15}]}', '["pill","stat","str","intermediate"]', '比壮骨丹更上一层的炼体丹，力道稳步提升，适合筑基中期修士。'),
