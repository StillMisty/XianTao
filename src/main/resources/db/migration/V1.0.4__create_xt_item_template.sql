...
(
    ...
    CONSTRAINT chk_item_template_type CHECK (type IN ('MATERIAL', 'SEED', 'BEAST_EGG', 'POTION', 'SKILL_JADE', 'RECIPE_SCROLL', 'FORGING_BLUEPRINT', 'HERB', 'BEAST_ESSENCE'))
);
...
COMMENT ON COLUMN xt_item_template.type IS '物品类型 (MATERIAL, SEED, BEAST_EGG, POTION, SKILL_JADE, RECIPE_SCROLL, HERB)';
