...
(
    ...
    CONSTRAINT chk_item_template_type CHECK (type IN ('MATERIAL', 'SEED', 'BEAST_EGG', 'POTION', 'EVOLUTION_STONE', 'SKILL_JADE', 'RECIPE_SCROLL', 'FORGING_BLUEPRINT', 'HERB', 'BEAST_ESSENCE'))
);
