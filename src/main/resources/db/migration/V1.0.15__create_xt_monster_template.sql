...
CREATE
    TABLE
        xt_monster_template(
            ...
            CONSTRAINT chk_monster_template_type CHECK(
                monster_type IN(
                    'BEAST',
                    'SPIRIT',
                    'ARMORED',
            ...
            CONSTRAINT chk_monster_template_base_level CHECK(
                base_level >= 1
            ),
            CONSTRAINT chk_monster_template_base_hp CHECK(
                base_hp >= 0
            ),
            CONSTRAINT chk_monster_template_base_attack CHECK(
                base_attack >= 0
            ),
            CONSTRAINT chk_monster_template_base_defense CHECK(
                base_defense >= 0
            ),
            CONSTRAINT chk_monster_template_base_speed CHECK(
                base_speed >= 0
            ),
            CONSTRAINT chk_monster_template_exp_reward CHECK(
                exp_reward >= 0
            )
        );
