...
INSERT
    ...
    VALUES(
        '小狐妖',
        '毛茸茸的狐耳少女，会偷偷往你的仓库里塞药草——但别让她发现你在吃狐狸肉。',
        '["herb","beast","healing","seed","silk"]',
        '["demon","poison","evil","metal","draconic"]'
    ),
    (
        '剑灵',
        '从古剑中苏醒的剑魂，不怎么说话但看剑的眼神很专注。',
        '["sword","blade","attack","ore","metal"]',
        '["poison","dark","chaos","staff","herb"]'
    ),
    (
        '老槐树精',
        '不知活了多少年的槐树精，说话慢悠悠的，喜欢讲过去的故事——虽然讲了也记不住。',
        '["wood","herb","seed","tree","earth"]',
        '["fire","poison","metal","chaos","demon"]'
    ),
    (
        '石狮子',
    ...
    (
        '书灵',
        '从一个千年古籍中化出的灵体，知识渊博但稍微有点书呆子气。',
        '["wisdom","skill_jade","water","silk","star"]',
        '["fire","beast","chaos","demon","warrior"]'
    ),
    (
        '蝴蝶仙',
        '一只修炼千年的蝴蝶，振翅时花气飘散，喜欢花花草草。',
        '["flower","herb","seed","silk","healing"]',
        '["fire","metal","poison","dark","evil"]'
    ),
    (
        '黑白无常',
        '一个活泼的小无常，负责帮忙管理仓库的"灵魂"，喜欢有死气的东西。',
        '["dark","soul","evil","ghost","cure"]',
        '["yang","fire","sun","wisdom","healing"]'
    ),
    (
        '金蟾',
        '三足金蟾，蹲在灵石堆上就不动了，喜欢金光闪闪的东西。',
        '["metal","ore","fortune","gem","gold"]',
        '["water","ice","herb","seed","wood"]'
    ),
    (
        '童子',
    ...
    (
        ...
        '["warrior","evil","chaos","demon","attack"]'
    ),
    (
        '饕餮',
    ...
    (
        '白泽',
        '博学多闻的白泽之灵，有什么问题都可以问它。',
        '["wisdom","knowledge","star","skill_jade","water"]',
        '["ignorance","chaos","evil","poison","warrior"]'
    ),
    (
        '花妖',
        '花丛中化出的小妖灵，喜欢漂亮的东西和香喷喷的药草。',
        '["flower","herb","silk","beauty","sweet"]',
        '["ore","metal","bone","leather","dark"]'
    ),
    (
        '矿灵',
        '矿洞里的小精灵，对矿石有天然的亲和力，会帮主人找到好矿脉。',
        '["ore","metal","gem","craft","earth"]',
    ...
    (
        ...
        '["silk","herb","flower","poison","water"]'
    ),
    (
        '酿酒仙',
        '只关心酿酒这件事的仙灵，每天都醉醺醺的，但酿出的仙酿天下无双。',
        '["fruit","herb","water","sweet","wood"]',
    ...
    (
        '天狗',
        '传说中的天狗之灵，每到月食就特别兴奋（其实是饿了想吃月亮）。',
        '["moon","dark","beast","flying","star"]',
        '["sun","fire","metal","attack","loud"]'
    ),
    (
        '云灵',
        '一朵云成精了，软绵绵的像棉花糖，喜欢晒太阳变胖再下雨变瘦。',
        '["water","flying","sky","peace","weather"]',
        '["fire","dryness","metal","ore","underground"]'
    ),
    (
        '风灵',
        '一阵风成精了，来无影去无踪，最喜欢吹乱你的符纸然后咯咯笑。',
        '["flying","wind","speed","sky","freedom"]',
    ...
    (
        '精卫',
        '精卫填海的执念化灵，小小一只但叼石头的毅力让人动容。',
        '["sea","water","bird","stone","persistence"]',
        '["giveup","evil","chaos","lazy","demon"]'
    ),
    (
        '山童',
        '小山神座下的童子灵体，憨态可掬，把整座山当自家后院。',
        '["earth","stone","ore","mountain","craft"]',
        '["water","flood","sea","fish","flying"]'
    ),
    (
        '灶君',
        '灶神的童子灵体，喜欢往你的丹炉里偷加一把火。',
        '["fire","cook","pill","food","warm"]',
