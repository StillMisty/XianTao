...
COMMENT ON COLUMN xt_activity_event.event_type IS '事件类型: NUMERIC(数值效果) / COMBAT(遇怪战斗)';
...
COMMENT ON COLUMN xt_activity_event.params IS '事件效果参数 JSONB。NUMERIC: {"effects":[...]}  COMBAT: {"monster_template_id":N,"min_count":1,"max_count":3}';
