...
INSERT
    ...
    (
        ...
        '灵芝成精化作的小妖卵，天生精通草木之道，是炼丹修士最爱的福地伙伴。'
    ),
    (
        '铁羽鹰卵',
        'BEAST_EGG',
    ...
    (
        ...
        '["beast_egg","epic","auspicious","justice"]' ::jsonb,
        '能辨是非的神兽，以独角触碰可让人明辨善恶。魑魅魍魉见之退避三舍。'
    ),
    (
        '天狗卵',
        'BEAST_EGG',
        ...
        '["beast_egg","epic","beast","dark"]' ::jsonb,
        '传说能吞食月亮的天狗后裔，昼伏夜出。它的双眼中倒映着九幽星辰。'
    ),
    (
        '鸣蛇卵',
        'BEAST_EGG',
        ...
        '["beast_egg","rare","beast","fire","water"]' ::jsonb,
        '四翼飞蛇，声如鸣磬。水火交融于一身，《山海经》中镇压旱魃的灵物。'
    ),
    (
        '冉遗鱼卵',
        'BEAST_EGG',
        ...
        '["beast_egg","rare","water","heal"]' ::jsonb,
        '蛇首鱼身的异兽，浑身散发清冷月光。其泪可愈百创，是活生生的移动药泉。'
    ),
    (
        '雷鸟卵',
        'BEAST_EGG',
        ...
        '["beast_egg","rare","flying","thunder"]' ::jsonb,
        '生于雷云之上的猛禽，每次振翅都有电弧缠绕。风暴是它的猎场，雷霆是它的羽箭。'
    ),
    (
        '玄蜂卵',
        'BEAST_EGG',
        ...
        '["beast_egg","uncommon","insect","poison"]' ::jsonb,
        '腹大如壶的妖蜂，尾针之毒可麻木一头犀牛——但采集的蜜却是解毒圣品。'
    ),
    (
        '穿山甲卵',
        'BEAST_EGG',
