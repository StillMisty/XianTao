...
INSERT INTO xt_map_node (id, name, description, map_type, level_requirement, neighbors, specialties, encounter_richness) VALUES(1, '青石镇', '青山脚下的小镇，民风淳朴。镇口有座土地庙供往来修士歇脚，是大多数修仙者的起点。',
 'SAFE_TOWN', 1,
...
(10, '古道驿站', '官道旁的简陋驿站，供通往南方的修士和客商打尖过夜。旁边有个小坊市，可以买到一些基础物资。',
 ...
 jsonb_build_array(
  ...
  3);
INSERT INTO xt_map_node (id, name, description, map_type, level_requirement, neighbors, specialties, encounter_richness) VALUES
