...
CREATE INDEX idx_hidden_completion_lookup
    ON xt_hidden_completion(activity_type, owner_id);
...
COMMENT ON
COLUMN xt_hidden_completion.user_id IS '玩家 ID';

COMMENT ON
COLUMN xt_hidden_completion.activity_type IS '活动类型';

COMMENT ON
COLUMN xt_hidden_completion.owner_id IS '事件归属 ID';

COMMENT ON
COLUMN xt_hidden_completion.code IS '事件 code';

COMMENT ON
COLUMN xt_hidden_completion.completed_at IS '完成时间';
