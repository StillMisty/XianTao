...
| [用户系统设计](./用户系统设计.md)   | 角色、认证、属性、等级、突破、洗点、护道、体力                   |
| [地图探索系统](./地图探索系统.md)   | 地图节点、连通性、旅行、历练(AFK)、探索                    |
| [物品装备系统](./物品装备系统.md)   | 物品模板、装备生成、词条、背包管理                         |
| [福地系统设计](./福地系统设计.md)   | 福地管理、灵气、网格、种植、献祭、天劫、蛰伏                    |
| [地灵对话系统](./地灵对话系统.md)   | LLM 集成、MBTI 人格、Function Calling、Prompt 设计 |
| [命令参考](./命令参考.md)       | 完整玩家命令手册                                  |
| [实现路线图](./实现路线图.md)     | 当前进度、待实现功能、已知问题                           |
